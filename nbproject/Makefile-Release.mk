...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/contabilita.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/contabilita.exe: ${OBJECTFILES}
...
${OBJECTDIR}/b_menu.o: b_menu.f95
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/b_menu.o b_menu.f95

${OBJECTDIR}/controllo_quadratura_scarichi.o: controllo_quadratura_scarichi.f95
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/controllo_quadratura_scarichi.o controllo_quadratura_scarichi.f95

${OBJECTDIR}/input_file.o: input_file.f95
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/input_file.o input_file.f95
